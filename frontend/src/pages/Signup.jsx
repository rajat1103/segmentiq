...
const PRISM_TIPS = [
  ...
  "Create an account to unlock full AI-powered CRM features!",
  "I can segment customers, write campaigns & analyze revenue.",
  "Already have data? Upload a CSV and I'll analyze it instantly.",
  "Join SegmentIQ — it's free to get started! 🚀",
];
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          opacity: fade ? 1 : 0, transition: "opacity 0.30s ease",
          minHeight: "36px",
        }}>{PRISM_TIPS[tipIdx]}</p>
        <div style={{ display: "flex", gap: "3px", marginTop: "8px", justifyContent: "flex-end" }}>
          {PRISM_TIPS.map((_, i) => (
            <div key={i} style={{
